...
function CastCosmoRay( event )
	...
	-- Create particle FX
	local particleName = "particles/zema/phoenix_sunray.vpcf"
...
function CheckForCollision( event )
	...
	local Talent = caster:FindAbilityByName("special_bonus_unique_phoenix_5")
