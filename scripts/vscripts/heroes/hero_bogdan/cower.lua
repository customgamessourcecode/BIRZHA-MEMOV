function ModelSwapStart( keys )
	...
	local Talent = caster:FindAbilityByName("special_bonus_unique_warlock_3")
	...
	if Talent:GetLevel() == 1 then
		ability:ApplyDataDrivenModifier( caster, caster, "modifier_bogdan_cower_talent", { Duration = 10 })
	end
end
